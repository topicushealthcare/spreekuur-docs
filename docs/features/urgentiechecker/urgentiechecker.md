...
* If your practice needs to be enabled in the acceptance environment (so triage results are correctly associated with your practice), contact the Spreekuur integration team to request access/registration for the practice AGB code.
